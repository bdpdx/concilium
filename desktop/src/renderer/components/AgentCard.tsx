...
function getProviderColor(provider: AgentProvider): string {
  return (
    PROVIDERS.find((p) => p.id === provider)?.color ?? "var(--color-text-muted)"
  );
}
            ...
            >
              <Command className="flex flex-col" shouldFilter={true}>
                <div className="flex items-center border-b border-border-primary px-3">
                  <svg
                    className="w-3 h-3 text-text-muted shrink-0 mr-2"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
      ...
      <div className="flex items-center justify-between px-4 pb-4 mt-2 relative z-10">
        <div className="flex items-center gap-2">
          <div
            ...
            style={{
              backgroundColor: instance.enabled
                ? "#22C55E"
                : "var(--color-text-muted)",
            }}
          />
          ...
          <span
            ...
            style={{
              color: instance.enabled ? "#22C55E" : "var(--color-text-muted)",
            }}
          >
